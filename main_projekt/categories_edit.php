...
if (!SessionPermissionsUtils::CheckIfPermExistsOnResource('write_all', 'categories')) {
...
if (isset($_GET['id']) && is_numeric($_GET['id']))
{
    ...
    if ($category == false) {
        header('Location: categories_list.php?alert_type=3&alert_message=Položka neexistuje');
        die();
    }
}
else {
